...
try {
    ...
    if ($method === 'GET') {
        ...
        switch ($type) {
                ...
                if ($product_id > 0) {
                    ...
                    if ($product_result && mysqli_num_rows($product_result) > 0) {
                        ...
                        $query = "SELECT s.id, s.ma_sanpham, s.tieu_de, s.minh_hoa, s.gia_cu, s.gia_moi, s.gia_ctv, s.thuong_hieu, 
                                  ...
                                  LEFT JOIN transport t ON s.kho_id = t.id
                                  LEFT JOIN tinh_moi tm ON t.province = tm.id
                                  WHERE s.kho > 0 $exclude_condition
                                  AND (
                        ...
                        $query = "SELECT s.id, s.ma_sanpham, s.tieu_de, s.minh_hoa, s.gia_cu, s.gia_moi, s.gia_ctv, s.thuong_hieu, 
                                  ...
                                  LEFT JOIN transport t ON s.kho_id = t.id
                                  LEFT JOIN tinh_moi tm ON t.province = tm.id
                                  WHERE s.kho > 0 AND s.box_banchay = 1 $exclude_condition
            ...
            case 'bestseller':
                ...
                $query = "SELECT s.id, s.ma_sanpham, s.tieu_de, s.minh_hoa, s.gia_cu, s.gia_moi, s.gia_ctv, s.thuong_hieu, 
                          ...
                          LEFT JOIN transport t ON s.kho_id = t.id
                          LEFT JOIN tinh_moi tm ON t.province = tm.id
                          WHERE s.kho > 0 AND s.box_banchay = 1 $category_condition $exclude_condition
                          ORDER BY s.ban DESC, s.view DESC 
                          LIMIT $limit";
                break;
            ...
            case 'featured':
                ...
                $query = "SELECT s.id, s.ma_sanpham, s.tieu_de, s.minh_hoa, s.gia_cu, s.gia_moi, s.gia_ctv, s.thuong_hieu, 
                          ...
                          LEFT JOIN transport t ON s.kho_id = t.id
                          LEFT JOIN tinh_moi tm ON t.province = tm.id
                          WHERE s.kho > 0 AND s.box_noibat = 1 $category_condition $exclude_condition
            ...
            case 'flash_sale':
                ...
                $query = "SELECT s.id, s.ma_sanpham, s.tieu_de, s.minh_hoa, s.gia_cu, s.gia_moi, s.gia_ctv, s.thuong_hieu, 
                          ...
                          LEFT JOIN transport t ON s.kho_id = t.id
                          LEFT JOIN tinh_moi tm ON t.province = tm.id
                          WHERE s.kho > 0 AND s.box_flash = 1 $category_condition $exclude_condition
            ...
            case 'newest':
                ...
                $query = "SELECT s.id, s.ma_sanpham, s.tieu_de, s.minh_hoa, s.gia_cu, s.gia_moi, s.gia_ctv, s.thuong_hieu, 
                          ...
                          LEFT JOIN transport t ON s.kho_id = t.id
                          LEFT JOIN tinh_moi tm ON t.province = tm.id
                          WHERE s.kho > 0 $category_condition $exclude_condition
        ...
        $row['product_url'] = 'https://socdo.vn/san-pham/' . $row['id'] . '/' . $row['link'] . '.html';
            ...
            $row = addProductBadgesAndLocation($row, $conn);
            ...
            if ($row['has_voucher']) $badges[] = 'Voucher';
            if ($row['has_freeship']) $badges[] = $row['freeship_label'] ?: 'Freeship';
            $badges[] = 'Chính hãng';
